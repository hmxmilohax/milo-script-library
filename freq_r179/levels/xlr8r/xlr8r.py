...
class XLR8RLevel (Level):
    def __init__ (self):
        ...
        self.track_enable_criteria = ('yes', 1, 1, 3, 4, 5, 3, 3)
        self.game_bg_criteria = ((2,3,4),(2,3,4,6),(1,2,3,4,5,6), 'yes', 'yes', 'yes', 'yes', 'yes')
    ...
    def get_genre (self):       return "Rock'n'Roll Baby"
    def get_tempo (self):       return "135"
    def get_description (self): return "Orbit's signature sound combines driving and dynamic bass and guitar lines with passionate vocals melodies. Their hit \"Medicine\" from 1997's 'Libido Speedway' earned them a spot on the Lollapalooza tour and all the usual hype. www.orbitband.com."
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            return [67, 67]             # core 0: 52 left, 52 right
        else:
