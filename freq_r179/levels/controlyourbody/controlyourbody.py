...
class ControlYourBodyLevel (Level):
    def __init__ (self):
        ...
        self.fx_volume      = 50
        self.freestyle_points = [20, 20, 20]
        self.materials = ("drum",
                          "bass",
                          "drum",
                          "synth",
    ...
    def get_description (self): return "Let the beat control your body in this massive hard house favorite. check out www.symbionproject.com for more music."
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            return [50, 50]               # Core 0 has delay time of 35
        else:
