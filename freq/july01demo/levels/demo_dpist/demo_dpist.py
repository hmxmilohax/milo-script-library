...
#
# $Header: j:\\cvs/Freq/run/Levels/demo_dpist/demo_dpist.py,v 1.1.2.2 2001/07/17 20:31:29 jon Exp $
#
...
class dubpistolsLevel (Level):
    ...
    def get_description (self): return "The Dub Pistols explode on the scene with Official Chemical. Their followup album to Point Blank is the new album Six Million Ways to Live - available August 2001. www.dubpistols.net"
