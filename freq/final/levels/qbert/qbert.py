...
#
# $Header: j:\\cvs/Freq/run/Levels/qbert/qbert.py,v 1.20 2001/10/10 02:10:59 anon Exp $
...
class qbertLevel (Level):
    def __init__ (self):
        ...
        self.section_instances =   [0, 1, 2, 3, 0, 1, 2, 3, 5, 4, 6]
        self.fx_stt         = (120, 0)
        self.fx_volume      = 50
        self.freestyle_points = [7, 10, 10]
        self.linked_sections = [[ [0,4] ],
                                [ [1,5], [2,6] ],
                                [ [0,4] ],
                                [ [1,5], [2,6] ],
                                [ [0,4] ],
    ...
    def get_description (self): return "DJ QBert is widely considered the greatest skratch DJ in the world.  His film and skratch album \"Wave Twisters\" received international attention and praise.  www.djqbert.com"
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            return [75, 75]             # core 0: 45 left, 45 right
        else:
