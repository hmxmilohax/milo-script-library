...
class powerLevel (Level):
    ...
    def get_description (self): return "They came from Boston, a raging crux of metallic funk juice and silver alloy inlayed sonic mayhem hurtling through the atmosphere, skimming under the radar as an unidentified flying object known only by the hidden codename of Powerman 5000.  www.powerman5000.com"
