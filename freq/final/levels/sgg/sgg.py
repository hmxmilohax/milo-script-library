...
#
# $Header: j:\\cvs/Freq/run/Levels/sgg/sgg.py,v 1.21 2001/10/10 20:23:22 anon Exp $
## sections:
#
# 0 intro A
# 1 verse 1 B
...
class sggLevel (Level):
    def __init__ (self):
        ...
        self.track_enable_criteria = ('yes', 1, 1, 2, 2, 3, 3, 1)
    ...
    def get_abbrev_name (self): return "Science Genius"
    def get_artist (self):      return "Freezepop"
    def get_genre (self):       return "synthpop"
    def get_tempo (self):       return "137"
    def get_description (self): return "Freezepop is a trio of fashionable gadabouts from Boston with an infectious flair for synthpop songs about robots, and love, and loving robots. Look for their full length album, 'Freezepop Forever,' and other goodies at www.freezepop.net."
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            return [50, 50]              # Core 0 has delay time of 45
        else:
            return [60, 60]              # Core 1 has delay time of 86
