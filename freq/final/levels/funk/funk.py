...
#
# $Header: j:\\cvs/Freq/run/Levels/funk/funk.py,v 1.14 2001/10/10 02:07:31 anon Exp $
## sections:
#
# 0 verse 1 no vox
# 1 verse 2 and bridge 12 bars
# 2 chorus 1 [same as section 6]
# 3 c section
# 4 verse 3 no vox
# 5 verse 4 and bridge 12 bars
# 6 chorus 1 [same as section 2]
# 7 c section
# 8 breakdown
# 9 verse 5 and bridge 12 bars
# 10 chorus 2 
# 11 chorus 3
...
class funkLevel (Level):
    def __init__ (self):
        ...
        self.freestyle_points = [4, 8, 9]
        self.section_boundaries = [8, 20, 28, 36, 44, 56, 64, 72, 80, 92, 100, 108]
        self.section_instances =   [0, 1, 2, 3, 0, 5, 2, 3, 8, 9, 10, 11]
        self.linked_sections = [[ [1,5], [2,11], [0,8] ],         #T1
                                [ [5,9], [2,10], [0,8] ],         #T2
                                [ [1,5], [2,11] ],        #T3
                                [ [5,9], [2,10], [0,8] ],                        #T4
                                [ [1,5], [2,11] ],                 #T5
    ...
    def get_artist (self):      return "Funkstar De Luxe"
