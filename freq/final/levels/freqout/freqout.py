...
class freqoutLevel (Level):
    ...
    def get_abbrev_name (self): return "FreQ Out"
    def get_artist (self):      return "Symbion Project"
    def get_genre (self):       return "hard breakz"
    def get_tempo (self):       return "155"
    def get_description (self): return "Symbion Project hitz you one last time with an aggressive breakbeat masterpiece. This one is going to wear you down.  www.symbionproject.com"
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            return [80, 80]               # Core 0 has delay depth of 25
        else:
