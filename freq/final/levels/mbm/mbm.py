...
class MbmLevel (Level):
    ...
    def get_name (self):        return "Dynamite Fresh"
    def get_abbrev_name (self): return "Dynamite Fresh"
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            ...
            return [40, 40]               # Core 1 has delay time of 00
        
    # What is the delay time for the given core?  Only valid for echo and delay.
    # Scale is 0-127
    def ps2_hard_delay_time (self, core):
        if core == 0:
            return 64                     # Core 0 has delay time of 64
        else:
            return 15                     # Core 1 has delay time of 00
