...
class winnerLevel (Level):
    ...
    def get_description (self): return "Scott Kirkland and Ken Jordan, a.k.a. The Crystal Method, are back with their new album, 'Tweekend.' This bass-fortified, hard-rolling techno concoction will get the club kids moving.  www.thecrystalmethod.com"
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            return [65, 65]               # Core 0 has delay time of 30
        else:
            return [75, 75]               # Core 1 has delay time of 50
