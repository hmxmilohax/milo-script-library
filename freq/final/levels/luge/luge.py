...
#
# $Header: j:\\cvs/Freq/run/Levels/luge/luge.py,v 1.12 2001/10/10 20:17:15 anon Exp $
#
...
class lugeLevel (Level):
    ...
    def get_artist (self):      return "SurgeCore"
    def get_genre (self):       return "melodica"
    def get_tempo (self):       return "120"
    def get_description (self): return "With a background shrouded in mystery, rumor, and whispered half-truths, SurgeCore has emerged from the post-industrial German heartland with an assault of melodic electronica. Choirs of robots sing the praises of a new synthetic dawn.  www.surgecore.com"
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            return [45, 45]               # Core 0 has delay time of 40
        else:
    ...
    def ps2_hard_delay_time (self, core):
        if core == 0:
            return 47                     # Core 0 has delay time of 60
        else:
