...
#
# $Header: j:\\cvs/Freq/run/Levels/Ronisize/Ronisize.py,v 1.24 2001/10/10 20:22:20 anon Exp $
#
...
class RonisizeLevel (Level):
    ...
    def get_description (self): return "Roni Size is probably the most successful and innovative producer to have emerged from the UK drum'n'bass explosion. Roni has his own underground label, Full Cycle, plus his group Reprazent, with collaborators Krust, Die, Suv, and Dynamite MC.  www.ronisize.com"
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            return [40, 40]               # Core 0 has delay time of 40
        else:
    ...
    def ps2_hard_delay_time (self, core):
        if core == 0:
            return 61                     # Core 0 has delay time of 60
        else:
            return 60                      # Core 1 has delay time of 70
