...
# arg is: 0 - bad, 1 - good, 2 - great
    def on_health (self, arg):
        ...
        hx.anim_speed ("blue_shaded.mnm", (4, 20, 30)[arg])
        hx.anim_speed ("green_shaded.mnm", (4, 15, 20)[arg])
	...
	hx.anim_speed ("purple_cube.mnm", (3, 24, 30)[arg])
        ...
        hx.anim_speed ("portal_lanternfloor.mnm", (3, 16, 24)[arg])
        hx.anim_speed ("portal_lanternbase.mnm", (3, 16, 24)[arg])
        hx.anim_speed ("redsphere.mnm", (0, 25, 30)[arg])
        hx.anim_speed ("outer_01.lnm", (6, 30, 40)[arg])
	hx.anim_speed ("outer_01.tnm", (4, 12, 20)[arg])
	hx.anim_speed ("circ_green_layers.mnm", (.2, 1, 1.25)[arg])
	hx.anim_speed ("circ_mod_layers.mnm", (.2, 1, 1.25)[arg])
        
	hx.anim_speed ("4_portal_01.view", (.05, 1, 4)[arg])
        hx.anim_speed ("4_portal_02.view", (.05, 1, 4)[arg])
        hx.anim_speed ("4_portal_03.view", (.05, 1, 4)[arg])
        hx.anim_speed ("4_portal_04.view", (.05, 1, 4)[arg])
