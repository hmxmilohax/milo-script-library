...
class junoLevel (Level):
    def __init__ (self):
        ...
        self.game_bg_criteria = ((3),'yes', (1,2,3,4,5,6), 'yes', 'yes', 'yes', 'yes', 'yes')
    ...
    def get_description (self): return "Juno Reactor are constantly challenging the concept of what an electronic based band should be and sound like as can be found on the latest \"Shango\" album. They push the boundaries even further with their live show in which South African percussionists Amampondo.  www.reactorleak.com"
