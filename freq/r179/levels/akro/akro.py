...
#
# $Header: j:\\cvs/Freq/run/Levels/akro/akro.py,v 1.10 2001/09/23 23:40:42 kasson Exp $
#
...
class akroLevel (Level):
    def __init__ (self):
        ...
        self.linked_sections = [[ [0,1,5], [2,6], [3,4], [8,9] ],	#T1 drums1
                                [ [0,2,5], [1,6], [3,4], [8,9] ],       #T2 bass
                                [ [0,1,5], [2,6], [8,9] ],              #T3 drums2
                                [ [0,2], [3,4], [8,9] ],		        #T4 synth1
                                [ [3,4,7], [8,9] ],                     #T5 synth2
                                [ [3,4,7], [8,9] ],		        #T6 vocals
                                [],
                                []]
    ...
    def get_description (self): return "Boston born and raised MC & producer Akrobatik is best known for his underground classics \"Say Yes Say Word\" and \"Internet MC's.\" His self-titled EP on Detonator Records further solidified his position as one of hip-hop's brightest new talents. www.detonatorrecords.com"
