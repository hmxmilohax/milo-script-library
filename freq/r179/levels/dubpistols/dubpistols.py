...
class dubpistolsLevel (Level):
    ...
    def get_description (self): return "The Dub Pistols' Barry Ashworth is a fearless soldier working behind the frontlines of the UK¹s thriving dance music scene.  Barry began his musical journey by working as a club promoter, and later formed the Dub Pistols in 1996.  www.dubpistols.net"
