...
class EndOfYourWorldLevel (Level):
    ...
    def get_artist (self):      return "Robotkid vs InnerSekt"
    def get_genre (self):       return "Bionic Sonic Beats"
    def get_tempo (self):       return "160"
    def get_description (self): return "Robotkid and InnerSekt duke it out on the dancefloor with 'End of Your World.'  Put on your stompin' boots and get on down.  Remixed by Symbion Project.  www.robotkid.com"
