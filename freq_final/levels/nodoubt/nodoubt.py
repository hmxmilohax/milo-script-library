...
class nodoubtLevel (Level):
    ...
    def get_name (self):        return "Ex-Girlfriend (Remix)"
    ...
    def get_description (self): return "Formed in Anaheim, California in 1987, No Doubt deliver a signature mix of rock, reggae, and new-wave musical styles. Their most widely known albums include 'Tragic Kingdom' and 'Return of Saturn.'  www.nodoubt.com"
    ...
    def ps2_hard_delay_time (self, core):
        if core == 0:
            return 55                     # Core 0 has delay time of 55
        else:
