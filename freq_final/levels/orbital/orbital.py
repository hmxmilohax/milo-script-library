...
#
# $Header: j:\\cvs/Freq/run/Levels/orbital/orbital.py,v 1.21 2001/10/10 20:19:06 anon Exp $
## sections:
#
...
class orbitalLevel (Level):
    def __init__ (self):
        ...
        self.freestyle_points = [4, 8, 10]
        self.section_boundaries = [8, 16, 24, 32, 40, 48, 56, 64]
        self.section_instances =   [0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6]
        self.materials = ("drum",
                          "bass",
                          "synth",
                          "vocal",
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            return [55, 55]               # Core 0 has delay time of 55
        else:
            return [45, 45]               # Core 1 has delay time of 50
