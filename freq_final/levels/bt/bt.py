...
#
# $Header: j:\\cvs/Freq/run/Levels/BT/BT.py,v 1.19 2001/10/10 20:09:28 anon Exp $
#
...
class BTLevel (Level):
    ...
    def get_description (self): return "Artist, producer, composer, and remixer BT has been busy. Not only is he working on a follow-up to his album, 'Movement in Still Life,' but he has also produced *NSYNC's hit single \"Pop\" and remixed tracks for Sarah McLachlan, Tori Amos, Madonna, and Seal.  www.btmusic.com"
    ...
    def ps2_hard_effect_volumes (self, core):
        if core == 0:
            return [50, 50]               # Core 0 has delay time of 40
        else:
