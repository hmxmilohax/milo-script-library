...
class BlueArena (Arena):
    ...
    def on_health (self, arg):
        ...
        hx.anim_speed ("meshgens.view", (0, .25, 1)[arg])
        hx.anim_speed ("particle_system.view", (.1, .75, .75)[arg])
        hx.anim_speed ("sleeve_05.tnm", (0, 1, 3)[arg])
        hx.anim_speed ("sleeve_06.tnm", (0, 1, 3)[arg])
